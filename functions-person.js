function insertDeclNdflIfIpIfQuartIs4 () {
          ...
          $('#qrt-4-2016').prop('checked') ) )  
    {
        ...
        if ( $('#qrt-4-2014').prop('checked') ) {
            $('#div-from-customer-ip').before('<div><label id="label-decl-ndfl-ip-4-2014" for="decl-ndfl-ip-4-2014"><input id="decl-ndfl-ip-4-2014" type="checkbox" name="decl-ndfl-ip-4-2014" checked>Налоговая декларация 3-НДФЛ за 2014 год</label></div>');
        }
    }  
}
...
function insertNalogDecl () {
          ...
          $('#year-2014-ip-simple').prop('checked') ) )  
    {
        ...
        if ( $('#year-2014-ip-simple').prop('checked') ) {
            $('#div-from-customer-ip').before('<div class="nalog-decl"><label><input id="decl-year-2014-ip-simple" type="checkbox" name="decl-year-2014-ip-simple" checked>Налоговая декларация за 2014 год</label></div>');
        }
    }  
}
